...
import family from '../../../img/immigration/family.webp';
import partner from '../../../img/home/lawyers/demidov-aleksandr.webp';

export default function Immigration() {
  return (
    <React.Fragment>
      <div className='page-bg-wrap' id='immigration-bg'>
        <div className='page-header-wrap'>
          <h1>Иммиграция на Кипр</h1>
        </div>
      </div>
      <div className='page-content'>
        <div className='page-content-grid'>
          <div className='page-maintext'>
            <h2>Наши юристы помогут Вам переехать на Кипр и получить вид на жительство на легко и без стресса.</h2>
            <h3>Переезжайте на Кипр, не беспокоясь о сложностях и рисках вашего вида на жительство (включая разрешение на временное или постоянное проживание и работу).</h3>
            <h3>
              Получите консультацию по подходящему иммиграционному разрешению для Вас, 
              выберите время для записи в органах власти Кипра и получите помощь в подготовке вашего заявления 
              на получение регистрационного сертификата (yellow slip, pink slip) и постоянного вида на жительство.
            </h3>
            <p>
              Получите вид на жительство на Кипре, постоянный (Fast track или категория F)
              и временный сертификаты (Cyprus Yellow Slip, Cyprus Pink Slip) 
              безопасно и быстро с нашими иммиграционными юристами.
            </p>
            <p>
              Большинство людей, переезжающих на Кипр, не знают, с чего начать, 
              как справиться с юридическими тонкостями своего проживания, 
              как взаимодействовать с иностранными властями, бюрократическими процедурами и как избежать ловушек в процессе.
            </p>
            <p>
              Таким образом, процесс может стать сложным, а опасения по поводу неправильных заявлений, 
              недостаточной документации, отсутствия записи и языкового барьера затруднят переезд на Кипр.
            </p>
            <h3>Мы поможем Вам получить временный и постоянный вид на жительство на Кипре быстро, без проблем и забот.</h3>
            <img src={family} alt='img'/>
            <h3>Мы предоставляем юридические услуги людям, которые хотят иммигрировать на Кипр, купить недвижимость на Кипре и открыть свои кипрские компании.</h3>
            <h4>1. Получите консультацию по подходящему виду на жительство на Кипре (yellow slip, pink slip, категория F, Fast track PR 6.2)</h4>
            <p>
              Ищете вид на жительство на Кипре для граждан России? Или вид на жительство из стран СНГ? 
              Вы цифровой кочевник, желающий переехать на Кипр, или бизнесмен, желающий основать свою компанию на Кипре?
            </p>
            <p>
              Мы сообщим Вам, какой вид на жительство является наиболее подходящим для Вас, исходя из ваших требований и предпосылок. 
              Мы объясним процесс и дадим список необходимых документов, а также список всех расходов от начала до конца. 
              Это позволит Вам иметь ясность и заранее спланировать свои следующие шаги, в том числе, 
              как получить право на участие в Общей системе здравоохранения Кипра (GESY), 
              а также как стать налоговым резидентом Кипра без постоянного места жительства и как обустроить свой бизнес на Кипре.
            </p>
            <h4>2. Проверка документов, организация встречи в иммиграционной службе и открытие банковского счета (до приезда)</h4>
            <p>
              Вы будете удивлены, как часто заявки людей на вид на жительство на Кипре отклоняются из-за неправильной документации 
              и насколько неприятными могут быть плохая организация и планирование.
            </p>
            <p>
              Мы сообщим Вам, какие документы вам нужны, и проверим все документы, которые вы готовите, 
              до Вашего переезда на Кипр и встречи с иммиграционными властями, 
              чтобы Ваше заявление было на 100% правильным, и Вам не пришлось беспокоиться об этом.
            </p>
            <p>
              Если требуется банковский счет, мы также можем подготовить его для Вас до Вашего приезда, 
              чтобы, когда Вы приедете на Кипр, Вы просто подписали документы и активировали свой счет в течение нескольких минут. 
              Мы тоже посетим банк с Вами, чтобы Вы не беспокоились об этом.
            </p>
            <p>Если требуется медицинская страховка, мы также можем организовать ее для Вас.</p>
            <h4>3. Посещение иммиграционной службы Кипра вместе с Вами во время Вашей встречи.</h4>
            <p>
              Когда наступит срок Вашей встречи, мы пойдем с Вами и подадим иммиграционное заявление в иммиграционную службу. 
              Вам не придется беспокоиться о чрезмерных задержках и длинных очередях, 
              недопонимании с властями или бюрократических процедурах государственных органов на Кипре.
            </p>
            <h2>Готовы ли Вы переехать на Кипр легко и без стресса? Свяжитесь с нами для бесплатной консультации.</h2>
          </div>
          ...
          <div className='page-partner-grid'>
            ...
            <div className='quote'>
              <p>
                Мы считаем, что люди, переезжающие на Кипр, приносят пользу всему сообществу, 
                и нам нравится облегчать им получение вида на жительство на Кипре, покупку дома и открытие своего бизнеса.
                <br/>
                <em>Александр Демидов - Руководящий партнер.</em>
              </p>
            </div>
          </div>
          <div className='page-about-grid'>
            ...
            <div className='third'>
              ...
              <p>
                ...
                Нельзя работать на Кипре
              </p>
              <p>
                <svg viewBox='0 0 256 512'>
                  <path d='M224.3 273l-136 136c-9.4 9.4-24.6 9.4-33.9 0l-22.6-22.6c-9.4-9.4-9.4-24.6 0-33.9l96.4-96.4-96.4-96.4c-9.4-9.4-9.4-24.6 0-33.9L54.3 103c9.4-9.4 24.6-9.4 33.9 0l136 136c9.5 9.4 9.5 24.6.1 34z'/>
                </svg>
                Необходим депозит на счете
              </p>
            </div>
