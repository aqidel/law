...
export default function Property() {
  return (
    <React.Fragment>
      <div className='page-bg-wrap' id='property-bg'>
      ...
      <div className='page-content'>
        <div className='page-content-grid'>
          <div className='page-maintext'>
            ...
            <h3>Защитите себя от проблем с застройщиками на Кипре, ипотекой и иными обременениями, а также от дефектных или незаконных построек.</h3>
            <img src={villa} alt='img'/>
            <h3>Мы предоставляем юридические услуги людям, которые хотят продать или купить недвижимость на Кипре или инвестировать в недвижимость на Кипре.</h3>
