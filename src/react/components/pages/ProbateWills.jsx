...
export default function ProbateWills() {
  return (
    <React.Fragment>
      <div className='page-bg-wrap' id='pw-bg'>
      ...
      <div className='page-content'>
        <div className='page-content-grid'>
          <div className='page-maintext'>
            ...
            <h2>Избегайте чрезмерных затрат и задержек при оформлении завещания на Кипре. Получите бесплатную консультацию и смету.</h2>
          </div>
